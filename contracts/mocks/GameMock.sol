...
contract GameMock is Game {
    ...
    function cards(address _address) public view returns (Cards.Data memory) {
        return players[_address].cards;
    }

    function contributions(address _address) public view returns (uint256) {
        return players[_address].contributions;
    }

    function setGameOver() public {
        ended = true;
    }
}
